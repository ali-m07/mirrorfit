...
MirrorFit is a production-ready, white-labelable **augmented-reality virtual clothing try-on system**. A shopper stands in front of a webcam, and garments from your catalog — t-shirts, hoodies, jackets, dresses — are composited onto their body in real time, tracking shoulders, torso scale, tilt and arm occlusion. Sessions are captured as shareable screenshots and videos.
